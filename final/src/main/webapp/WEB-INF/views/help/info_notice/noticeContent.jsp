...
<jsp:include page="/WEB-INF/views/userNavBar.jsp"/>
	...
	<input type="button" value="수정" onclick="window.location = '/community/notice/modNotice?pnum=${board.pnum}&pageNum=${pageNum}' " />
	<input type="button" value="삭제" onclick="window.location = '/community/notice/delNotice?pnum=${board.pnum}&pageNum=${pageNum}' " />
	<input type="button" value="목록" onclick="window.location = '/community/notice/noticeList?board_type=6' "/>
