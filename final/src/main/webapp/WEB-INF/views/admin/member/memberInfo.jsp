...
<body>
	...
	<section style="margin: 20px 5% 10% 20%">
		...
		<input type="button" class="btn btn-outline-primary" value="사원 전환" onclick="window.location='/admin/emp/addEmp?memid=${dto.memid}'">
		<details>
		...
		<br>
		<input type="button" class="btn btn-primary" style="margin-top:20px" value="회원목록" onclick="window.location='/admin/member/list'">
	</section>
</body>
