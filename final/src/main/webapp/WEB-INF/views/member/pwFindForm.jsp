...
<body>
	...
	<section style="margin: 20px 10% 10% 30%">
		...
		<div style="margin-top:5%;float:left">
			<button class="btn btn-outline-primary" onclick="window.location='/member/agreeForm'">회원가입</button>
			<button class="btn btn-outline-primary" onclick="window.location='/member/idFindForm'">아이디 찾기</button>
		</div>
	</section>
