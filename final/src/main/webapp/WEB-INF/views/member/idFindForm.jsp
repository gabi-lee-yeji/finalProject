	...
	<section style="margin: 20px 10% 10% 30%">
		...
		<form action="/member/idFindPro" method="post" onSubmit="return Check()" style="margin-top: 5%">
			...
			전화번호:	<select name="pC">
					...
					<input type="text" name="phone1" style="width:5%" onkeyup="noSpaceForm(this);" onchange="noSpaceForm(this);"/>
					-
					<input type="text" name="phone2" style="width:8%" onkeyup="noSpaceForm(this);" onchange="noSpaceForm(this);"/>
					-
					<input type="text" name="phone3" style="width:8%" onkeyup="noSpaceForm(this);" onchange="noSpaceForm(this);"/><br/>
